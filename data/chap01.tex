...
这是 \szuthesis{} 的示例文档，基本上覆盖了模板中所有格式的设置。建议大家在使用模
板之前，除了阅读《\szuthesis{}用户手册》，这个示例文档也最好能看一看。
...
\begin{table}[htb]
  ...
  \label{tab:template-files}
    \begin{tabular*}{\linewidth}{lp{10cm}}
      ...
      szuthesis.ins & \LaTeX{} 安装文件，docstrip\footnote{表格中的脚注} \\
      szuthesis.dtx & 所有的一切都在这里面\footnote{再来一个}。\\
      szuthesis.cls & 模板类文件。\\
      szuthesis.cfg & 模板配置文。cls 和 cfg 由前两个文件生成。\\
      szubib.bst    & 参考文献 Bibtex 样式文件。\\
      szutils.sty   & 常用的包和命令写在这里，减轻主文件的负担。\\
      \bottomrule[1.5pt]
    \end{tabular*}
  \end{minipage}
\end{table}
...
\begin{table}[h]
 ...
 \multirow{2}*{\backslashbox{x}{y}}  & \multicolumn{2}{c|}{First Half} & \multicolumn{2}{c|}{Second Half}\\\cline{2-5}
    ...
    \end{tabularx}\\[2pt]
    \footnotesize 注：数据来源《\szuthesis{} 使用手册》。\\
    *：东部\\
    **：西部
  \end{minipage}
\end{table}
...
\begin{table}[hb]
  ...
  \begin{tabular}[c]{|c|m{0.8in}|c|c|c|c|c|}\hline
    ...
    \multirow{2}{1in}{Xue} & Rui  & Ni &\multicolumn{4}{c|}{\multirow{2}*{\szuthesis}}\\\cline{2-3}
...
本模板推荐使用 BIB\TeX，样式文件为 szubib.bst，基本符合学校的参考文献格式（如专利
